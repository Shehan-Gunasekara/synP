  ...
  const generateLipSync = async () => {
    ...
    for (const stage of stages) {
      ...
      while (Date.now() - startTime < stage.duration) {
        ...
        const stageProgress = Math.min(100, (elapsed / stage.duration) * stage.progress);
    ...
    setLipSyncedVideoUrl("https://res.cloudinary.com/deov2upvz/video/upload/v1736660122/dmiqfqhpnlbkufzkneqj.mov");
    setLoading(false);
  ...
  return (
    <Card className="py-6 px-2 sm:p-6 space-y-6 mx-0 sm:mx-14 sm:min-w-[570px]">
      ...
      <div className="text-[10px] sm:text-xs text-gray-500">
        Preview the demo audio that will be used for lip sync
      </div>
            ...
            <label className="flex flex-col items-center justify-center gap-4 p-8 border-2 border-dashed rounded-lg">
              ...
              <div className="text-center">
                ...
                <p className="text-[10px] sm:text-xs text-gray-500 mt-1">
                  This is a preview of the lip sync feature
                </p>
              </div>
            </label>
          </div>
