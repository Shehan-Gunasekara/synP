...
export function DemoPromptInput({
  ...
  const generateActor = async () => {
    ...
    setVideoUrl("https://v3.fal.media/files/koala/z_E1Fvk3Q-jfbzB2Ebb6M_video-1736493463.mp4");
  ...
  return (
    <div className="space-y-12">
      <section id="prompt-input" className="space-y-8">
        <DemoTextArea value={'Charismatic young professional with a warm smile and confident demeanor. They speak with enthusiasm and natural gestures, wearing business casual attire...'}/>
        <DemoSettings />
